  ...
  return (
    <section id="experience" className="py-20 px-6" ref={sectionRef}>
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          <h2 className={`text-3xl font-bold mb-4 transition-all duration-1000 ${isVisible ? 'animate-fade-in-up' : 'opacity-0 translate-y-10'}`}>
            Experience
          </h2>
          <p className={`text-lg text-muted-foreground max-w-2xl leading-relaxed transition-all duration-1000 delay-200 ${isVisible ? 'animate-fade-in-up' : 'opacity-0 translate-y-10'}`}>
